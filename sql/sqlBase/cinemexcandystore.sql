...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-01-2020 a las 20:17:45
...
INSERT INTO `catalogue` (`id`, `code`, `name`, `description`, `maxStock`, `minStock`, `categoryID`, `containerID`, `dateExpiry`) VALUES
(1, 'Mantqui', 'Mantequilla', 'Mantequilleishon', 100, 5, 1, 2, '2020-02-14'),
(2, 'MaPal', 'Maiz Palomero', 'Maizeishon', 10, 3, 2, 1, '2020-04-09'),
(3, 'Pasta', 'Pasta de Codito', 'En buen estado', 100, 10, 2, 3, '2025-12-31');
...
(2, 'Hector', 'Bando', 'Jimenez', 'password', 2),
(3, 'Raquel', 'Guevara', 'Soto Mayor', 'password', 3);
